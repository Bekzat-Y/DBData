...
create table Passenger (
                           id_pass int primary key not null ,
...
create table pass_in_trip (
                              ...
                              passenger_id int ,
                              place varchar,
                              foreign key (id)   references Passenger(id_pass)
);
...
alter table trip add  column time_in varchar;
...
insert into Passenger(id_pass,name) values
                                        (1,'Bruce Willis'),
                                        (2,'George Clooney'),
                                        (3,'Kevin Costner'),
                                        (4,'Donald Sutherland'),
...
insert into pass_in_trip (id, trip ,passenger_id, place) values
                                                             ( 1,   1100         ,1       ,        '1a'),
                                                             (  2,   1123    ,3     ,           ' 2a'),
                                                             (   3,   1123    ,1   ,          '4c'),
                                                             (  4,   1123    ,6    ,         ' 4b'),
...
select count(*) from trip where plane like 'TU-134';

SELECT name from trip    join Company C on trip.company = C.id where plane = 'Boeing';

SELECT company FROM trip WHERE town_to = 'Moscow';
